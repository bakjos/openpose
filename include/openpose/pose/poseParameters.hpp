...
namespace op
{
    ...
    const std::map<unsigned char, std::string> POSE_COCO_BODY_PARTS = boost::assign::map_list_of<unsigned char, std::string>
        (0,  "Nose")
        (1,  "Neck")
        (2,  "RShoulder")
        (3,  "RElbow")
   ...
   const std::map<unsigned char, std::string> POSE_MPI_BODY_PARTS = boost::assign::map_list_of<unsigned char, std::string>
        (0, "Head")
        (1, "Neck")
        (2, "RShoulder")
        (3, "RElbow")
    ...
    // Auxiliary functions
	OPENPOSE_API unsigned char poseBodyPartMapStringToKey(const PoseModel poseModel, const std::string& string);
	OPENPOSE_API unsigned char poseBodyPartMapStringToKey(const PoseModel poseModel, const std::vector<std::string>& strings);
}
